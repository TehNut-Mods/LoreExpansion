        ...
        for (int i = 0; i < par1Str.length(); ++i) {
            ...
            if (c0 == 167 && i + 1 < par1Str.length()) {
                ...
                if (this.strikethroughStyle) {
                    ...
                    tessellator.getBuffer().pos((double) this.posX, (double) (this.posY + (float) (this.FONT_HEIGHT / 2)), 0.0D);
                    tessellator.getBuffer().pos((double) (this.posX + f1), (double) (this.posY + (float) (this.FONT_HEIGHT / 2)), 0.0D);
                    tessellator.getBuffer().pos((double) (this.posX + f1), (double) (this.posY + (float) (this.FONT_HEIGHT / 2) - 1.0F), 0.0D);
                    tessellator.getBuffer().pos((double) this.posX, (double) (this.posY + (float) (this.FONT_HEIGHT / 2) - 1.0F), 0.0D);
                    tessellator.draw();
                ...
                if (this.underlineStyle) {
                    ...
                    tessellator.getBuffer().pos((double) (this.posX + (float) l), (double) (this.posY + (float) this.FONT_HEIGHT), 0.0D);
                    tessellator.getBuffer().pos((double) (this.posX + f1), (double) (this.posY + (float) this.FONT_HEIGHT), 0.0D);
                    tessellator.getBuffer().pos((double) (this.posX + f1), (double) (this.posY + (float) this.FONT_HEIGHT - 1.0F), 0.0D);
                    tessellator.getBuffer().pos((double) (this.posX + (float) l), (double) (this.posY + (float) this.FONT_HEIGHT - 1.0F), 0.0D);
                    tessellator.draw();
                    GlStateManager.enableTexture2D();
                }
